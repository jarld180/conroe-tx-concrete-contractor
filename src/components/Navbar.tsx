...
const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    },
    {
      ...
      dropdown: [
        { name: 'Conroe', path: '/' },
        { name: 'The Woodlands', path: '/the-woodlands' },
        { name: 'Spring', path: '/spring' },
        { name: 'Willis', path: '/willis' },
        { name: 'Montgomery', path: '/montgomery' },
        { name: 'Magnolia', path: '/magnolia' }
      ]
    }
  ];
        ...
        <div className="p-8 h-full flex flex-col text-black">
          <div className="flex justify-between items-start mb-12 gap-4">
            <Link to={currentCity ? `/${currentCity}` : "/"} onClick={() => handleLinkClick(currentCity ? `/${currentCity}` : "/")} className="flex items-start space-x-2 min-w-0">
              ...
              <span className="text-xl font-bold uppercase tracking-tighter text-black truncate">Conroe <span className="text-black">Concrete</span></span>
            </Link>
          ...
          <div className="mt-auto pt-8 border-t border-gray-100">
            ...
            <p className="text-center mt-4 text-black font-bold text-sm">(936) 312-3589</p>
          </div>
        </div>
      </div>
    </>
